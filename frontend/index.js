        ...
        html += `
            <div class="cart-item">
                ...
                <div style="display:flex; align-items:center; gap:8px;">
                    <button onclick="changeQuantity(${index}, -1)" style="width:28px;height:28px;background:#1a4d5c;color:white;border:none;border-radius:6px;cursor:pointer;">–</button>
                    <span style="min-width:24px;text-align:center;">${qty}</span>
                    <button onclick="changeQuantity(${index}, 1)" style="width:28px;height:28px;background:#1a4d5c;color:white;border:none;border-radius:6px;cursor:pointer;">+</button>
                </div>
                <button onclick="removeFromCart(${index})" style="background:none;border:none;color:#ff6b6b;font-size:1.5rem;cursor:pointer;margin-left:10px;">×</button>
            </div>
        `;
    });
    ...
    const checkoutHTML = `
        <div style="position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.9); z-index:3000; display:flex; align-items:center; justify-content:center;">
            <div style="background:#062D38; padding:30px; border-radius:16px; width:90%; max-width:500px;">
                ...
                <textarea id="cliente-direccion" placeholder="Dirección completa" style="width:100%; padding:12px; margin:8px 0; background:#0A3D4A; border:none; border-radius:8px; color:white; min-height:80px;"></textarea>
